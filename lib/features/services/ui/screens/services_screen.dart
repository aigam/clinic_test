...
import '../../../../core/compoents/modal_bottoms/main_components/close_modal_widget.dart';
// import '../../../../core/compoents/modal_bottoms/main_components/modal_bottom_component.dart';
                          ...
                          child: InkWell(
                            onTap: () async {
                              ...
                              await showModalBottomSheet(
                                ...
                                builder: (BuildContext bContext) => SafeArea(
                                  child: Container(
                                    ...
                                    child: Stack(
                                      children: [
                                        ServiceModalBody(
                                          ...
                                          advantages:
                                              serviceProvider.advantageList,
                                          onAccept: (BuildContext newContext) {
                                            staffProvider
                                                .creteOrderBySttaffAndId(
                                              serviceIds: [
                                                serviceProvider
                                                    .serviceList[index]
                                                    .yclientsId!
